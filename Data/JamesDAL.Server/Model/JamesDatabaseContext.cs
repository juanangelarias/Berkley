...
public partial class JamesDatabaseContext : DbContext
{
    ...
    public virtual DbSet<AgencyCommission> AgencyCommissions { get; set; }
    ...
    public virtual DbSet<AgencyLineOfAuthorityAgent> AgencyLineOfAuthorityAgents { get; set; }

    public virtual DbSet<AgencyLineOfAuthorityLog> AgencyLineOfAuthorityLogs { get; set; }
    ...
    public virtual DbSet<AuthorityUsedDm> AuthorityUsedDms { get; set; }
    ...
    public virtual DbSet<BondRequest> BondRequests { get; set; }

    public virtual DbSet<BondRequestCommercial> BondRequestCommercials { get; set; }
    ...
    public virtual DbSet<BusinessTypeRiskCodeDm> BusinessTypeRiskCodeDms { get; set; }
    ...
    public virtual DbSet<CreditReportHistory> CreditReportHistories { get; set; }
    ...
    public virtual DbSet<EmailTypeDm> EmailTypeDms { get; set; }

    public virtual DbSet<Employee> Employees { get; set; }

    public virtual DbSet<FinancialAccountTypeDm> FinancialAccountTypeDms { get; set; }

    public virtual DbSet<FinancialAggregate> FinancialAggregates { get; set; }

    public virtual DbSet<FinancialDefaultAccount> FinancialDefaultAccounts { get; set; }
    ...
    public virtual DbSet<FinancialTypeDm> FinancialTypeDms { get; set; }
    ...
    public virtual DbSet<IndustryCodeDm> IndustryCodeDms { get; set; }
    ...
    public virtual DbSet<KeyPersonnel> KeyPersonnel { get; set; }
    ...
    public virtual DbSet<PersonalFinancialFor> PersonalFinancialFors { get; set; }
    ...
    public virtual DbSet<PrivateEquity> PrivateEquities { get; set; }
    ...
    public virtual DbSet<RateGroupDm> RateGroupDms { get; set; }
    ...
    public virtual DbSet<TransactionPurposeDm> TransactionPurposeDms { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.Property(e => e.SharedSurety).HasMaxLength(100);
            ...
            entity.HasOne(d => d.Agent).WithMany(p => p.Accounts)
                .HasForeignKey(d => d.AgentId)
                .HasConstraintName("FK_Account_Agent");
            ...
            entity.HasOne(d => d.BusinessTypeRiskCode).WithMany(p => p.Accounts)
                .HasForeignKey(d => d.BusinessTypeRiskCodeId)
                .HasConstraintName("FK_Account_BusinessTypeRiskCodeDM");
            ...
            entity.HasOne(d => d.IndustryCodeNavigation).WithMany(p => p.Accounts)
                .HasForeignKey(d => d.IndustryCode)
                .HasConstraintName("FK_Account_IndustryCodeDM");
        ...
        modelBuilder.Entity<AccountProgram>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.AccountNum, e.Effective }, "IX_AccountProgram_AccountNumEffective");
        ...
        modelBuilder.Entity<AccountProgramEmailNotificationGroup>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.AccountProgramEmailNotificationGroups)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountProgramEmailNotificationGroups_Employee");
        });
        ...
        modelBuilder.Entity<AccountProgramStatusHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.AccountProgram).WithMany(p => p.AccountProgramStatusHistories)
                .HasForeignKey(d => d.AccountProgramId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountProgramStatusHistory_AccountProgram");

            entity.HasOne(d => d.NewStatusNavigation).WithMany(p => p.AccountProgramStatusHistoryNewStatusNavigations)
                .HasForeignKey(d => d.NewStatus)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountProgramStatusHistory_AccountProgramStatusDM");

            entity.HasOne(d => d.OldStatusNavigation).WithMany(p => p.AccountProgramStatusHistoryOldStatusNavigations).HasForeignKey(d => d.OldStatus);

            entity.HasOne(d => d.StatusChangeByNavigation).WithMany(p => p.AccountProgramStatusHistories)
                .HasForeignKey(d => d.StatusChangeBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountProgramStatusHistory_Employee");
        });
        ...
        modelBuilder.Entity<AccountStatusLog>(entity =>
        {
            ...
            entity.HasOne(d => d.ModifiedByNavigation).WithMany(p => p.AccountStatusLogs)
                .HasForeignKey(d => d.ModifiedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountStatusLog_Employee");
        });

        modelBuilder.Entity<AccountWatch>(entity =>
        {
            entity.ToTable("AccountWatch", tb => tb.HasTrigger("trgAccountWatchModified"));
        ...
        modelBuilder.Entity<AdditionalObligee>(entity =>
        {
            ...
            entity.HasOne(d => d.BondNumberNavigation).WithMany(p => p.AdditionalObligeesNavigation)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AdditionalObligee_Bond");

            entity.HasOne(d => d.Obligee).WithMany(p => p.AdditionalObligees)
                .HasForeignKey(d => d.ObligeeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AdditionalObligee_Obligee");
        });
        ...
        modelBuilder.Entity<AddressTypeDm>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_AddressTypeDM_Id").IsUnique();

            entity.HasIndex(e => e.Order, "UQ_AddressTypeDM_Order").IsUnique();
        ...
        modelBuilder.Entity<AgencyCommission>(entity =>
        {
            ...
            entity.HasOne(d => d.Agency).WithMany(p => p.AgencyCommissions)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.AgencyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AgencyCommission_Agency");
        });
        ...
        modelBuilder.Entity<AgencyCompetition>(entity =>
        {
            ...
            entity.HasOne(d => d.EnteredByNavigation).WithMany(p => p.AgencyCompetitions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AgencyCompetition_Employee");
        });
        ...
        modelBuilder.Entity<AgencyErrorAndOmission>(entity =>
        {
            ...
            entity.HasOne(d => d.Agency).WithMany(p => p.AgencyErrorAndOmissions)
                ...
                .HasForeignKey(d => d.AgencyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AgencyErrorAndOmission_Agency");
        });
        ...
        modelBuilder.Entity<AgencyInventory>(entity =>
        {
            ...
            entity.HasOne(d => d.ApproverNavigation).WithMany(p => p.AgencyInventories)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AgencyInventory_Employee");
        ...
        modelBuilder.Entity<AgencyLineOfAuthorityAgent>(entity =>
        {
            entity.HasKey(e => e.Id).IsClustered(false);

            entity.ToTable("AgencyLineOfAuthorityAgent", tb => tb.HasTrigger("trgAgencyLineOfAuthorityAgentModified"));
            ...
            entity.HasOne(d => d.AgencyLineOfAuthority).WithMany(p => p.AgencyLineOfAuthorityAgents)
                .HasForeignKey(d => d.AgencyLineOfAuthorityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AgencyLineOfAuthorityAgent_AgencyLineOfAuthorityLog");

            entity.HasOne(d => d.Agent).WithMany(p => p.AgencyLineOfAuthorityAgents)
                .HasForeignKey(d => d.AgentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AgencyLineOfAuthorityAgent_Agent");
        });

        modelBuilder.Entity<AgencyLineOfAuthorityLog>(entity =>
        {
            entity.HasKey(e => e.Id).IsClustered(false);

            entity.ToTable("AgencyLineOfAuthorityLog", tb => tb.HasTrigger("trgAgencyLineOfAuthorityLogModified"));

            entity.HasIndex(e => e.Effective, "IX_AgencyLineOfAuthorityLog_Effective");

            entity.HasIndex(e => e.Expiration, "IX_AgencyLineOfAuthorityLog_Expiration");
        ...
        modelBuilder.Entity<AgencyStatusLog>(entity =>
        {
            ...
            entity.HasOne(d => d.OldStatusNavigation).WithMany(p => p.AgencyStatusLogOldStatusNavigations).HasForeignKey(d => d.OldStatus);
        });
        ...
        modelBuilder.Entity<AgentSystemDm>(entity =>
        {
            ...
            entity.ToTable("AgentSystemDM", tb => tb.HasTrigger("trgAgentSystemDMModified"));
        ...
        {
            entity.HasKey(e => new { e.AgentId, e.AgencyId }).IsClustered(false);
            ...
            entity.HasOne(d => d.Agent).WithMany(p => p.AgentsInAgencies)
                .HasForeignKey(d => d.AgentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<AuthorityUsedDm>(entity =>
        {
            entity.HasKey(e => e.AuthorityUsed).IsClustered(false);

            entity.ToTable("AuthorityUsedDM", tb => tb.HasTrigger("trgAuthorityUsedDMModified"));

            entity.HasIndex(e => e.Id, "UQ_AuthorityUsedDM_Id").IsUnique();

            entity.Property(e => e.AuthorityUsed)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.Created)
        ...
        modelBuilder.Entity<BidPercentDm>(entity =>
        {
            ...
            entity.ToTable("BidPercentDM", tb => tb.HasTrigger("trgBidPercentDMModified"));
        ...
        {
            entity.HasKey(e => e.Description).IsClustered(false);

            entity.ToTable("BidResultDM", tb => tb.HasTrigger("trgBidResultDMModified"));

            entity.HasIndex(e => e.Id, "UQ_BidResultDM_Id").IsUnique();
        ...
        modelBuilder.Entity<BidStatusDm>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_BidStatusDM_Id").IsUnique();
        ...
        modelBuilder.Entity<Bond>(entity =>
        {
            ...
            entity.HasOne(d => d.UnderWriter).WithMany(p => p.Bonds)
                .HasForeignKey(d => d.UnderWriterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Bond_UnderWriter");
        });
        ...
        modelBuilder.Entity<BondBlock>(entity =>
        {
            ...
            entity.HasOne(d => d.Agency).WithMany(p => p.BondBlocks)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.AgencyId)
                .HasConstraintName("FK_BondBlock_Agency");

            entity.HasOne(d => d.Insurer).WithMany(p => p.BondBlocks)
                .HasForeignKey(d => d.InsurerId)
                .HasConstraintName("FK_BondBlock_Insurer");
        ...
        modelBuilder.Entity<BondBlockAllowedAgency>(entity =>
        {
            ...
            entity.ToTable("BondBlockAllowedAgency", tb => tb.HasTrigger("trgBondBlockAllowedAgencyModified"));
        ...
        modelBuilder.Entity<BondHold>(entity =>
        {
            ...
            entity.HasOne(d => d.HomeOfficeApprovedByNavigation).WithMany(p => p.BondHolds).HasForeignKey(d => d.HomeOfficeApprovedBy);
            ...
            entity.HasOne(d => d.UnderWriter).WithMany(p => p.BondHolds)
                .HasForeignKey(d => d.UnderWriterId)
                .HasConstraintName("FK_BondHold_UnderWriter");
        });

        modelBuilder.Entity<BondModTransaction>(entity =>
        {
            entity.HasKey(e => new { e.BondNumber, e.BondMod }).IsClustered(false);
            ...
            entity.HasOne(d => d.BondNumberNavigation).WithMany(p => p.BondModTransactions)
                .HasForeignKey(d => d.BondNumber)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondModTransaction_Bond");
        });

        modelBuilder.Entity<BondRequest>(entity =>
        {
            entity.HasKey(e => e.BondRequestNumber);

            entity.ToTable("BondRequest", tb => tb.HasTrigger("trgBondRequestModified"));
            ...
            entity.HasOne(d => d.AccountNumNavigation).WithMany(p => p.BondRequests)
                .HasForeignKey(d => d.AccountNum)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondRequest_Account");

            entity.HasOne(d => d.BidResultNavigation).WithMany(p => p.BondRequests)
            ...
            entity.HasOne(d => d.HomeOfficeApproverNavigation).WithMany(p => p.BondRequestHomeOfficeApproverNavigations)
                .HasForeignKey(d => d.HomeOfficeApprover)
                .HasConstraintName("FK_BondRequest_Employee_HomeOfficeApprovedBy");

            entity.HasOne(d => d.Obligee).WithMany(p => p.BondRequests)
                .HasForeignKey(d => d.ObligeeId)
                .HasConstraintName("FK_BondRequest_Obligee");

            entity.HasOne(d => d.StatusNavigation).WithMany(p => p.BondRequests)
                .HasForeignKey(d => d.Status)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondRequest_BidStatusDM");

            entity.HasOne(d => d.UnderWriter).WithMany(p => p.BondRequests)
                .HasForeignKey(d => d.UnderWriterId)
                .HasConstraintName("FK_BondRequest_UnderWriterId");
        });

        modelBuilder.Entity<BondRequestCommercial>(entity =>
        {
            entity.HasKey(e => e.BondRequestNumber).IsClustered(false);

            entity.ToTable("BondRequestCommercial", tb => tb.HasTrigger("trgBondRequestCommercialModified"));
            ...
            entity.HasOne(d => d.AccountNumNavigation).WithMany(p => p.BondRequestCommercials)
                .HasForeignKey(d => d.AccountNum)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity.HasOne(d => d.HomeOfficeApprovedByNavigation).WithMany(p => p.BondRequestCommercialHomeOfficeApprovedByNavigations).HasForeignKey(d => d.HomeOfficeApprovedBy);

            entity.HasOne(d => d.Obligee).WithMany(p => p.BondRequestCommercials)
                .HasForeignKey(d => d.ObligeeId)
                .HasConstraintName("FK_BondRequestCommercial_LegalEntity");

            entity.HasOne(d => d.RecordedByNavigation).WithMany(p => p.BondRequestCommercialRecordedByNavigations).HasForeignKey(d => d.RecordedBy);

            entity.HasOne(d => d.SfaaCodeNavigation).WithMany(p => p.BondRequestCommercials)
                .HasForeignKey(d => d.SfaaCode)
                .HasConstraintName("FK_BondRequestCommercial_SFAA");

            entity.HasOne(d => d.StatusNavigation).WithMany(p => p.BondRequestCommercials)
                .HasForeignKey(d => d.Status)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondRequestCommercial_BidStatusDM");

            entity.HasOne(d => d.UnderWriter).WithMany(p => p.BondRequestCommercials)
                .HasForeignKey(d => d.UnderWriterId)
                .HasConstraintName("FK_BondRequestCommercial_UnderWriter");
        });
        ...
        modelBuilder.Entity<BondTransaction>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_BondTransaction_Id").IsUnique();
            ...
            entity.HasOne(d => d.AgencyChangeNavigation).WithMany(p => p.BondTransactionAgencyChangeNavigations)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.AgencyChange)
                .HasConstraintName("FK_BondTransaction_AgencyChange");

            entity.HasOne(d => d.Agency).WithMany(p => p.BondTransactionAgencies)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.AgencyId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondTransaction_Agency");
            ...
            entity.HasOne(d => d.DivisionNavigation).WithMany(p => p.BondTransactions)
                .HasForeignKey(d => d.Division)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondTransaction_DivisionDM");

            entity.HasOne(d => d.Insurer).WithMany(p => p.BondTransactions)
                .HasForeignKey(d => d.InsurerId)
                .HasConstraintName("FK_BondTransaction_Insurer");

            entity.HasOne(d => d.RegionNavigation).WithMany(p => p.BondTransactions)
                .HasForeignKey(d => d.Region)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondTransaction_RegionDM");
            ...
            entity.HasOne(d => d.StateNavigation).WithMany(p => p.BondTransactions)
                .HasForeignKey(d => d.State)
                .HasConstraintName("FK_BondTransaction_State");

            entity.HasOne(d => d.TransactionPurposeNavigation).WithMany(p => p.BondTransactions)
                .HasForeignKey(d => d.TransactionPurpose)
                .HasConstraintName("FK_BondTransaction_TransactionPurposeDM");

            entity.HasOne(d => d.Underwriter).WithMany(p => p.BondTransactions)
                .HasForeignKey(d => d.UnderwriterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondTransaction_UnderWriter");
        });
        ...
        modelBuilder.Entity<BondTransactionPurpose>(entity =>
        {
            ...
            entity.HasIndex(e => e.TransactionPurpose, "UQ_BondTransactionPurpose_TransactionPurpose").IsUnique();
            ...
            entity.HasOne(d => d.TransactionPurposeNavigation).WithOne(p => p.BondTransactionPurpose)
                .HasForeignKey<BondTransactionPurpose>(d => d.TransactionPurpose)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BondTransactionPurpose_TransactionPurposeDM");
        ...
        {
            entity.HasKey(e => new { e.BondType, e.BondClass });
        ...
        modelBuilder.Entity<Branch>(entity =>
        {
            ...
            entity.HasOne(d => d.HomeOfficeLeadNavigation).WithMany(p => p.Branches)
                .HasForeignKey(d => d.HomeOfficeLead)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<BusinessTypeRiskCodeDm>(entity =>
        {
            entity.HasKey(e => e.Id).IsClustered(false);

            entity.ToTable("BusinessTypeRiskCodeDM", tb => tb.HasTrigger("trgBusinessTypeRiskCodeDMModified"));
            ...
            entity.Property(e => e.NewName)
                .HasMaxLength(116)
                .IsUnicode(false)
                .HasComputedColumnSql("(case when [BusinessType]='Unassigned' then 'Unassigned' else ((case when [IsContract]=(1) then 'Contract' else 'Commercial' end+' - ')+isnull([SubType]+' - ',''))+[BusinessType] end)", false);
            entity.Property(e => e.OldName)
                .HasMaxLength(63)
                .IsUnicode(false)
                .HasComputedColumnSql("(case when [BusinessType]='Unassigned' then 'Unassigned' else (case when [IsContract]=(1) then 'Contract' else 'Commercial' end+' - ')+[BusinessType] end)", false);
        ...
        modelBuilder.Entity<CashFlowStatement>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_CashFlowStatement_Id").IsUnique();
            ...
            entity.Property(e => e.Basis)
                ...
                .IsUnicode(false);
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_CashFlowStatement_Created")
                .HasColumnType("datetime");
            entity.Property(e => e.Id).HasDefaultValueSql("(newid())", "DF_CashFlowStatement_Id");
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_CashFlowStatement_Modified")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<CoInsurer>(entity =>
        {
            ...
            entity.HasOne(d => d.Insurer).WithMany(p => p.CoInsurers)
                .HasForeignKey(d => d.InsurerId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CoInsurer_Insurer");
        });
        ...
        modelBuilder.Entity<CommercialFinancial>(entity =>
        {
            ...
            entity.ToTable("CommercialFinancial", tb => tb.HasTrigger("trgCommercialFinancialModified"));
        ...
        modelBuilder.Entity<CommercialRate>(entity =>
        {
            ...
            entity.HasOne(d => d.RateGroupNavigation).WithMany(p => p.CommercialRates)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommercialRate_RateGroupDM");
        ...
        modelBuilder.Entity<ContractRate>(entity =>
        {
            ...
            entity.HasOne(d => d.RateGroupNavigation).WithMany(p => p.ContractRates)
                .HasForeignKey(d => d.RateGroup)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ContractRate_RateGroupDM");
        });
        ...
        modelBuilder.Entity<CountryDm>(entity =>
        {
            ...
            entity.Property(e => e.Abbreviation)
                ...
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.AddressFinalLineFormat)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.Created)
        ...
        modelBuilder.Entity<CreditReportHistory>(entity =>
        {
            entity.HasKey(e => e.Id).IsClustered(false);

            entity.ToTable("CreditReportHistory", tb => tb.HasTrigger("trgCreditReportHistoryModified"));
            ...
            entity.HasOne(d => d.AccountNumNavigation).WithMany(p => p.CreditReportHistories)
                .HasForeignKey(d => d.AccountNum)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CreditReportHistory_Account");
        });
        ...
        modelBuilder.Entity<Currency>(entity =>
        {
            ...
            entity.ToTable("Currency", tb => tb.HasTrigger("trgCurrencyModified"));

            entity.HasIndex(e => e.Id, "UQ_Currency_Id").IsUnique();
        ...
        modelBuilder.Entity<DefaultGeneralLedgerAccount>(entity =>
        {
            ...
            entity.HasOne(d => d.AccountClassNavigation).WithMany(p => p.DefaultGeneralLedgerAccounts)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DefaultGeneralLedgerAccount_DivisionDM");
        });
        ...
        modelBuilder.Entity<EmailTypeDm>(entity =>
        {
            entity.HasKey(e => e.Type).IsClustered(false);

            entity.ToTable("EmailTypeDM", tb => tb.HasTrigger("trgEmailTypeDMModified"));

            entity.HasIndex(e => e.Id, "UQ_EmailTypeDM_Id").IsUnique();
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.ToTable("Employee", tb => tb.HasTrigger("trgEmployeeModified"));
            ...
            entity.HasOne(d => d.PrimaryBranch).WithMany(p => p.Employees)
                .HasPrincipalKey(p => p.Id)
        ...
        {
            entity.HasKey(e => e.FinancialAccountType).IsClustered(false);

            entity.ToTable("FinancialAccountTypeDM");

            entity.HasIndex(e => e.Id, "UQ_FinancialAccountTypeDM_Id").IsUnique();

            entity.Property(e => e.FinancialAccountType)
                .HasMaxLength(2)
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_FinancialAccountTypeDM_Created")
                .HasColumnType("datetime");
            entity.Property(e => e.Id).HasDefaultValueSql("(newsequentialid())", "DF_FinancialAccountTypeDM_Id");
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_FinancialAccountTypeDM_Modified")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<FinancialAggregate>(entity =>
        {
            entity.HasKey(e => e.Id).IsClustered(false);

            entity.ToTable("FinancialAggregate");

            entity.HasIndex(e => e.StatementId, "IX_FinancialAggregate_StatementId");

            entity.HasIndex(e => e.Id, "UQ_FinancialAggregate_Id").IsUnique();

            entity.Property(e => e.Id).HasDefaultValueSql("(newid())", "DF_FinancialAggregate_Id");
            entity.Property(e => e.AggregateLoa).HasColumnName("AggregateLOA");
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_FinancialAggregate_Created")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_FinancialAggregate_Modified")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.Statement).WithMany(p => p.FinancialAggregates)
                .HasForeignKey(d => d.StatementId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialAggregate_FinancialStatement");
        });
        ...
        modelBuilder.Entity<FinancialDetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.ParentId, "IX_FinancialDetail_ParentId");

            entity.HasIndex(e => e.StatementId, "IX_FinancialDetail_StatementId");
            ...
            entity.HasOne(d => d.Statement).WithMany(p => p.FinancialDetails)
                .HasForeignKey(d => d.StatementId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialDetail_FinancialStatement");
        });
        ...
        modelBuilder.Entity<FinancialRatio>(entity =>
        {
            ...
            entity.ToTable("FinancialRatio");

            entity.HasIndex(e => e.StatementId, "IX_FinancialRatio_StatementId");
            ...
            entity.Property(e => e.AppayableDaysAllowed).HasColumnName("APPayableDaysAllowed");
            entity.Property(e => e.AppayableDaysStated).HasColumnName("APPayableDaysStated");
            ...
            entity.Property(e => e.ArcollectionDatsNoReturnAllowed).HasColumnName("ARCollectionDatsNoReturnAllowed");
            entity.Property(e => e.ArcollectionDatsNoReturnStated).HasColumnName("ARCollectionDatsNoReturnStated");
            entity.Property(e => e.ArcollectionDaysAllowed).HasColumnName("ARCollectionDaysAllowed");
            entity.Property(e => e.ArcollectionDaysStated).HasColumnName("ARCollectionDaysStated");
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_FinancialRatio_Created")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_FinancialRatio_Modified")
                .HasColumnType("datetime");

            entity.HasOne(d => d.Statement).WithMany(p => p.FinancialRatios)
                .HasForeignKey(d => d.StatementId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialRatio_FinancialStatement");
        });
        ...
        modelBuilder.Entity<FinancialStatement>(entity =>
        {
            ...
            entity.ToTable("FinancialStatement");

            entity.HasIndex(e => e.FinancialType, "IX_FinancialStatement_FinancialType");

            entity.HasIndex(e => e.StatementDate, "IX_FinancialStatement_StatementDate");

            entity.HasIndex(e => new { e.StatementDate, e.Version, e.FinancialType }, "IX_FinancialStatement_StatementDate_Version_FinancialType");

            entity.HasIndex(e => e.Type, "IX_FinancialStatement_Type");

            entity.HasIndex(e => new { e.Version, e.FinancialType }, "IX_FinancialStatement_Version_FinancialType");

            entity.HasIndex(e => new { e.AccountNum, e.StatementDate, e.FinancialType, e.Version }, "UQ_FinancialStatement_AccountNum_StatementDate_FinancialType_Version").IsUnique();

            entity.Property(e => e.Id).HasDefaultValueSql("(newid())", "DF_FinancialStatement_Id");
            entity.Property(e => e.AccountNum)
                .HasMaxLength(8)
                .IsUnicode(false);
            entity.Property(e => e.Basis)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Completed).HasComputedColumnSql("([BalanceSheetCompleted]&[ProfitLossStatementCompleted])", false);
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_FinancialStatement_Created")
                .HasColumnType("datetime");
            entity.Property(e => e.FinancialType)
                .HasMaxLength(8)
                .IsUnicode(false);
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_FinancialStatement_Modified")
                .HasColumnType("datetime");
            entity.Property(e => e.Quality)
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.HasOne(d => d.BasisNavigation).WithMany(p => p.FinancialStatements)
                .HasForeignKey(d => d.Basis)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialStatement_StatementBasisDM");

            entity.HasOne(d => d.FinancialTypeNavigation).WithMany(p => p.FinancialStatements)
                .HasForeignKey(d => d.FinancialType)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialStatement_FinancialTypeDM");

            entity.HasOne(d => d.QualityNavigation).WithMany(p => p.FinancialStatements)
                .HasForeignKey(d => d.Quality)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialStatement_StatementQualityDM");

            entity.HasOne(d => d.ScalingNavigation).WithMany(p => p.FinancialStatements)
                .HasForeignKey(d => d.Scaling)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialStatement_ScalingDM");

            entity.HasOne(d => d.TypeNavigation).WithMany(p => p.FinancialStatements)
                .HasForeignKey(d => d.Type)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FinancialStatement_StatementTypeDM");
        });

        modelBuilder.Entity<FinancialTypeDm>(entity =>
        {
            entity.HasKey(e => e.FinancialType)
                .HasName("PK_FinancialType")
                .IsClustered(false);

            entity.ToTable("FinancialTypeDM");

            entity.HasIndex(e => e.Id, "UQ_FinancialType_Id").IsUnique();

            entity.Property(e => e.FinancialType)
                .HasMaxLength(8)
                .IsUnicode(false);
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_FinancialType_Created")
                .HasColumnType("datetime");
            entity.Property(e => e.Id).HasDefaultValueSql("(newid())", "DF_FinancialType_Id");
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_FinancialType_Modified")
                .HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<IndustryCodeDm>(entity =>
        {
            entity.HasKey(e => e.Code).IsClustered(false);

            entity.ToTable("IndustryCodeDM", tb => tb.HasTrigger("trgIndustryCodeDMModified"));

            entity.HasIndex(e => e.Id, "UQ_IndustryCodeDM_Id").IsUnique();
        ...
        modelBuilder.Entity<InventoryDocumentDm>(entity =>
        {
            ...
            entity.ToTable("InventoryDocumentDM", tb => tb.HasTrigger("trgInventoryDocumentDMModified"));
        ...
        modelBuilder.Entity<KeyPersonnel>(entity =>
        {
            ...
            entity.HasOne(d => d.AccountNumNavigation).WithMany(p => p.KeyPersonnel)
                .HasForeignKey(d => d.AccountNum)
                .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            entity.HasOne(d => d.ResponsibilityNavigation).WithMany(p => p.KeyPersonnel)
        ...
        modelBuilder.Entity<LawEntity>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithOne(p => p.LawEntity)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LawEntity_LegalEntity");
        });
        ...
        modelBuilder.Entity<LegalEntityAddress>(entity =>
        {
            ...
            entity.HasOne(d => d.Address).WithOne(p => p.LegalEntityAddress)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LegalEntityAddress_Address");
        ...
        modelBuilder.Entity<LegalEntityEmail>(entity =>
        {
            ...
            entity.HasOne(d => d.LegalEntity).WithMany(p => p.LegalEntityEmails)
                .HasForeignKey(d => d.LegalEntityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LegalEntityEmail_LegalEntity");

            entity.HasOne(d => d.TypeNavigation).WithMany(p => p.LegalEntityEmails)
                .HasForeignKey(d => d.Type)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_LegalEntityEmail_Type");
        });
        ...
        modelBuilder.Entity<LineOfAuthorityLog>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountNum, "IX_LineOfAuthorityLog_AccountNum");

            entity.HasIndex(e => new { e.AccountNum, e.Effective, e.Expiration }, "IX_LineOfAuthorityLog_AccountNumEffective_Expiration");

            entity.HasIndex(e => new { e.AccountNum, e.Status, e.Effective, e.Expiration }, "IX_LineOfAuthorityLog_AccountNum_StatusEffective_Expiration");
            ...
            entity.HasOne(d => d.ApprovedByNavigation).WithMany(p => p.LineOfAuthorityLogApprovedByNavigations)
                ...
                .HasConstraintName("FK_LineOfAuthorityLog_Employee");

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.LineOfAuthorityLogCreatedByNavigations).HasForeignKey(d => d.CreatedBy);
        ...
        modelBuilder.Entity<LineOfAuthorityReason>(entity =>
        {
            ...
            entity.ToTable("LineOfAuthorityReason", tb => tb.HasTrigger("trgLineOfAuthorityReasonModified"));
        ...
        modelBuilder.Entity<NoteTypeDm>(entity =>
        {
            ...
            entity.ToTable("NoteTypeDM", tb => tb.HasTrigger("trgNoteTypeDMModified"));
        ...
        modelBuilder.Entity<NotebookEntry>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.NotebookEntries)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_NotebookEntry_Employee");
        ...
        modelBuilder.Entity<NotificationGroup>(entity =>
        {
            ...
            entity.ToTable("NotificationGroup", tb => tb.HasTrigger("trgNotificationGroupModified"));
        ...
        modelBuilder.Entity<NotificationGroupMember>(entity =>
        {
            ...
            entity.ToTable("NotificationGroupMember", tb => tb.HasTrigger("trgNotificationGroupMemberModified"));
        ...
        modelBuilder.Entity<Obligee>(entity =>
        {
            ...
            entity.HasOne(d => d.EditedByNavigation).WithMany(p => p.Obligees)
                .HasForeignKey(d => d.EditedBy)
                .HasConstraintName("FK_Obligee_Employee");
        ...
        modelBuilder.Entity<PersonalFinancialFor>(entity =>
        {
            entity.HasKey(e => e.Id).IsClustered(false);

            entity.ToTable("PersonalFinancialFor");

            entity.HasIndex(e => e.Id, "UQ_PersonalFinancialFor_Id").IsUnique();

            entity.Property(e => e.Id).HasDefaultValueSql("(newid())", "DF_PersonalFinancialFor_Id");
            entity.Property(e => e.Comment).IsUnicode(false);
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_PersonalFinancialFor_Created")
                .HasColumnType("datetime");
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_PersonalFinancialFor_Modified")
                .HasColumnType("datetime");
            entity.Property(e => e.Name).HasMaxLength(35);

            entity.HasOne(d => d.IdNavigation).WithOne(p => p.PersonalFinancialFor)
                .HasForeignKey<PersonalFinancialFor>(d => d.Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PersonalFinancialFor_FinancialStatement");
        });
        ...
        modelBuilder.Entity<PhoneTypeDm>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_PhoneTypeDM_Id").IsUnique();

            entity.HasIndex(e => e.Order, "UQ_PhoneTypeDM_Order").IsUnique();
        ...
        {
            entity.HasKey(e => e.Name).IsClustered(false);

            entity.ToTable("PowerOfAttorneyDocumentNameDM", tb => tb.HasTrigger("trgPowerOfAttorneyDocumentNameDMModified"));

            entity.HasIndex(e => e.Id, "UQ_PowerOfAttorneyDocumentNameDM_Id").IsUnique();
        ...
        modelBuilder.Entity<PowerOfAttorneyDocumentStatus>(entity =>
        {
            ...
            entity.HasOne(d => d.DocumentType).WithMany(p => p.PowerOfAttorneyDocumentStatuses)
                .HasPrincipalKey(p => p.Id)
        ...
        modelBuilder.Entity<PowerOfAttorneyStatusDm>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_PowerOfAttorneyStatusDM_Id").IsUnique();
        ...
        modelBuilder.Entity<PrivateEquity>(entity =>
        {
            entity.HasKey(e => e.Id).IsClustered(false);

            entity.ToTable("PrivateEquity", tb => tb.HasTrigger("trgPrivateEquityModified"));
            ...
            entity.HasOne(d => d.AccountNumNavigation).WithMany(p => p.PrivateEquities)
                .HasForeignKey(d => d.AccountNum)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PrivateEquity_Account");

            entity.HasOne(d => d.EnteredByNavigation).WithMany(p => p.PrivateEquities)
                .HasForeignKey(d => d.EnteredBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PrivateEquity_Employee");
        });
        ...
        modelBuilder.Entity<ProfitCenter>(entity =>
        {
            ...
            entity.HasOne(d => d.UnderWriter).WithMany(p => p.ProfitCenters)
                .HasForeignKey(d => d.UnderWriterId)
                .HasConstraintName("FK_ProfitCenter_UnderWriter");
        });

        modelBuilder.Entity<RateGroupDm>(entity =>
        {
            entity.HasKey(e => e.RateGroup)
                .HasName("PK_RateGroup")
                .IsClustered(false);

            entity.ToTable("RateGroupDM", tb => tb.HasTrigger("trgRateGroupModified"));
        ...
        modelBuilder.Entity<RegionDm>(entity =>
        {
            ...
            entity.ToTable("RegionDM", tb => tb.HasTrigger("trgRegionDMModified"));

            entity.HasIndex(e => e.Id, "UX_RegionDM_Id").IsUnique();
        ...
        modelBuilder.Entity<RenewalRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.RenewalRequestSource).WithMany(p => p.RenewalRequests)
                .HasPrincipalKey(p => p.Id)
                .HasForeignKey(d => d.RenewalRequestSourceId)
                .HasConstraintName("FK_RenewalRequest_RenewalRequestSource");
        });
        ...
        modelBuilder.Entity<RenewalRequestSource>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_RenewalRequestSource_Id").IsUnique();
        ...
        modelBuilder.Entity<ResponsibilityDm>(entity =>
        {
            ...
            entity.ToTable("ResponsibilityDM", tb => tb.HasTrigger("trgResponsibilityDMModified"));
        ...
        modelBuilder.Entity<ResponsiblePartyTypeDm>(entity =>
        {
            ...
            entity.ToTable("ResponsiblePartyTypeDM", tb => tb.HasTrigger("trgResponsiblePartyTypeDMModified"));
        ...
        modelBuilder.Entity<Security>(entity =>
        {
            ...
            entity.HasOne(d => d.RoleNavigation).WithMany(p => p.Securities)
                .HasForeignKey(d => d.Role)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Security_SecurityRole");
        });
        ...
        modelBuilder.Entity<SecurityRole>(entity =>
        {
            ...
            entity.HasIndex(e => e.Id, "UQ_SecurityRole_Id").IsUnique();
        ...
        {
            entity.HasKey(e => e.SfaabondType).IsClustered(false);

            entity.ToTable("SFAABondTypeDM", tb => tb.HasTrigger("trgSFAABondTypeDMModified"));

            entity.HasIndex(e => e.Id, "UQ_SFAABondTypeDM_Id").IsUnique();
        ...
        modelBuilder.Entity<Surcharge>(entity =>
        {
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.Surcharges)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Surcharge_Employee");
        ...
        modelBuilder.Entity<TransactionPurposeDm>(entity =>
        {
            entity.HasKey(e => e.TransactionPurpose).IsClustered(false);

            entity.ToTable("TransactionPurposeDM");

            entity.HasIndex(e => e.Id, "UQ_TransactionPurposeDM_Id").IsUnique();

            entity.Property(e => e.TransactionPurpose)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.Created)
                .HasDefaultValueSql("(getdate())", "DF_TransactionPurposeDM_Created")
                .HasColumnType("datetime");
            entity.Property(e => e.Id).HasDefaultValueSql("(newsequentialid())", "DF_TransactionPurposeDM_Id");
            entity.Property(e => e.Modified)
                .HasDefaultValueSql("(getdate())", "DF_TransactionPurposeDM_Modified")
                .HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<Underwriter>(entity =>
        {
            ...
            entity.HasOne(d => d.HomeOfficeLeadNavigation).WithMany(p => p.UnderwriterHomeOfficeLeadNavigations)
                .HasForeignKey(d => d.HomeOfficeLead)
                .HasConstraintName("FK_UnderWriter_Employee_HomeOfficeLead");
            ...
            entity.HasOne(d => d.ReportsToNavigation).WithMany(p => p.UnderwriterReportsToNavigations)
                ...
                .HasConstraintName("FK_Underwriter_Employeee_ReportsTo");
        });
        ...
        modelBuilder.Entity<UnderwriterRecommendation>(entity =>
        {
            ...
            entity.HasOne(d => d.PostedByNavigation).WithMany(p => p.UnderwriterRecommendations)
                .HasForeignKey(d => d.PostedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UnderwriterRecommendation_Employee");
        });
        ...
        modelBuilder.Entity<UserLayoutColumn>(entity =>
        {
            ...
            entity.ToTable("UserLayoutColumn", "Beta", tb => tb.HasTrigger("trgUserLayoutColumnModified"));
        ...
        modelBuilder.Entity<UserLayoutWidget>(entity =>
        {
            ...
            entity.ToTable("UserLayoutWidget", "Beta", tb => tb.HasTrigger("trgUserLayoutWidgetModified"));
        ...
        modelBuilder.Entity<UserLineOfAuthority>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.UserLineOfAuthorityUsers)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_UserLineOfAuthority_Employee");
        });
        ...
        modelBuilder.Entity<UserMenu>(entity =>
        {
            ...
            entity.ToTable("UserMenu", "Beta", tb => tb.HasTrigger("trgUserMenuModified"));
        ...
        modelBuilder.Entity<UserPreference>(entity =>
        {
            ...
            entity.ToTable("UserPreference", "Beta", tb => tb.HasTrigger("trgUserPreferenceModified"));
        ...
        modelBuilder.Entity<UserSetting>(entity =>
        {
            ...
            entity.ToTable("UserSetting", tb => tb.HasTrigger("trgUserSettingModified"));

            entity.HasIndex(e => e.Id, "UQ_UserSetting_Id").IsUnique();
        ...
        modelBuilder.Entity<VSecurityPrincipal>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vSecurityPrincipal");

            entity.Property(e => e.Principal).HasMaxLength(128);
        });
        ...
        modelBuilder.Entity<VoidedBond>(entity =>
        {
            ...
            entity.HasOne(d => d.VoidedByNavigation).WithMany(p => p.VoidedBonds)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_VoidedBond_Employee");
        });
        ...
        modelBuilder.Entity<WritingCompanyDm>(entity =>
        {
            ...
            entity.ToTable("WritingCompanyDM", tb => tb.HasTrigger("trgWritingCompanyDMModified"));
