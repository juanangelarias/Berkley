...
namespace JamesWebUI.Shared.Services
{
    public class UserShared : IUserShared
    {
        ...
        public UserShared(ILogger<UserShared> logger, AuthenticationStateProvider authenticationStateProvider)
        {
        ...
        public Task<SiteUserInfo> GetUserInfoAsync(ClaimsPrincipal principal)
        {
            ...
            {
                EntraId = principal.FindFirst(ClaimTypes.NameIdentifier)?.Value,
                Username = username,
