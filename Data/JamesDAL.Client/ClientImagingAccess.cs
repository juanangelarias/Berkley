...
namespace James.Data.Client
{
    public class ClientImagingAccess: ImagingAccessBase
    {
        ...
        public override Task UploadDocument(string docType, string filename, Stream fileContentStream, string contentType, ImagingDocumentCategory category, string id, string batchName, DateTime scanDate, CancellationToken cancellationToken = default)
        {
