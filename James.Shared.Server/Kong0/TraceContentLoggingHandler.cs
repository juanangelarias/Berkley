...
namespace James.Shared.Server.Kong0
{
    ...
    /// <remarks>This should only be used in debugging and turned off in production</remarks>
    public class TraceContentLoggingHandler(HttpMessageHandler innerHandler, ILogger logger) : DelegatingHandler(innerHandler)
    {
